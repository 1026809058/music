<template>
	<view class="list" :style="`height:${height} !important`">
		<view v-for="(item, index) in musicList" :key="item.id" class="list-item">
			...
			<view class="item_b">
				<image src="@/static/svg/tianjiayinyue.svg" class="tianj-svg" mode="" @click.stop="addPlayList(item)"></image>
...
<script setup>
	...
	const addPlayList=((val)=>{
		...
		console.log(playerStore.playlists);
	})
</script>
