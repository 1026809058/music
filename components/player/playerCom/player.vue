<template>
	<view class="player">
		...
		<view @touchmove.stop='stopTouchMove'>
			<view class="progress">
				<up-slider v-model="movableX" step="1" :max="parseInt(audioManager.duration||0)" activeColor="#03090f" inactiveColor="#c0c4cc"
					@change="movableChange"></up-slider>
				<view class="time">
			...
			<view class="cut">
				...
				<view class="cut_3 xy-center">
					<image class="svg" :src="'/static/svg/bofangliebiao.svg'"></image>
				</view>
			</view>
		</view>
	</view>
